...
module.exports = function (app) {
    ...
    var websiteModel = require('./model/website/website.model.server')(userModel);
    var pageModel = require('./model/page/page.model.server')(websiteModel);
    var widgetModel = require('./model/widget/widget.model.server')(pageModel);
